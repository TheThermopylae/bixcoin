<template>
  <section class="bg-white rounded-xl p-4">
    <article class="border p-2 rounded-lg flex justify-between items-center">
      <div class="flex items-center gap-2">
        <div
          class="w-12 h-12 rounded-full bg-amber-100 flex justify-center items-center"
        >
          <svg
        ...
        <div>
          <span class="text-[13px]">6 دقیقه پیش</span>
          <p class="text-[15px]">ورود موفق به حساب</p>
        </div>
      </div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
