<template>
  <article class="relative p-3 rounded-xl">
    <div class="flex justify-center -mb-5">
      <img
        class="w-20 -translate-y-1/2"
        src="https://www.bybit.com/leaderboard/images/default_avatar.png"
        alt="profile"
      />
    </div>
    <div class="text-center mb-3">
      <h4 class="font-yekSemiB text-xl">**am</h4>
      <div class="flex gap-5 justify-center flex-row-reverse text-lg">
        <span class="text-green-500">18W</span>
        <span class="text-primary">10B</span>
        <span class="text-blue-500">6M</span>
      </div>
    </div>
    <div>
      <p>PnL هفتگی (USD)</p>
      <span class="text-green-500 font-yekB text-xl">+2,590,962.65</span>
    </div>
    <div class="flex justify-between mt-3">
      ...
      <button
        class="px-4 py-2 border border-primary rounded text-primary hover:bg-primary hover:text-white transition-all"
      >
        دنبال کردن
      </button>
    </div>
