<template>
  <div class="relative hidden xl:block">
    <video src="/public/brandBg.mp4" autoplay class="h-screen"></video>
    <p class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-4xl text-gray-300 w-full text-center">فرصت تجارت بعدی خود را با بی ایکس غنیمت شمرده</p>
    <div class="absolute bottom-0 grid grid-cols-4 gap-5 p-5">
        <div class="relative">
